...
Table \ref{tab_soc_ext:offense_keys_code} illustrates which offenses are contained in the broad category. and in general how the penal codes of the German Criminal Code are translated into the offense key of the Police Crime Statistics.
...
%	\caption{The effect of Placebo games}\label{fig_soc_ext:}
