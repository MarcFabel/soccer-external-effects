...
\footnote{Only consider theories of why the rate of violence in increasing. There could be also the case of a decreasing assault rate due to soccer games. This could happen as an `self-incapacitation effect' due to the attendance of the match for individuals with a greater propensity to act violently as shown by \cite{dahl2009movie} for violent movies. Yet, only hourly data can reveal the presence of the `self-incapacitation effect'.}
		...
		* physiological arousal \cite{branscombe1992role}
