...
I undertake an indepth examination of the effects of public mass events on criminal behavior, more specifically the impact of soccer games of the first three leagues of the German football league systems is investigated.
...
- relevant fields of literature
	* College football 
		...
		-> sexual assault \cite{lindo2018college}				-> build upon identification strategy
		-> family violence \cite{card2011family}
		
	* soccer
		-> how time shapes crime \cite{montolio2016time}
		-> pick-pocketing and assaults \cite{montolio2019measuring}
...
% MISSING: AND ADJUSTfootnote in the beginning of the section
\cite{montolio2019measuring}
