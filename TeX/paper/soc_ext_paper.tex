...
\begin{align}
	\text{Crime}_{rdmy} = \alpha + \beta\ \text{Gameday}_{rdmy} + \underbrace{\gamma_d +  \eta_m + \theta_y}_{\text{date}_{dmy}} + \vartheta_r + X_{rdmy} \lambda + \varepsilon_{rdmy}
	\label{eq_soc_ext:model}
\end{align}
with Crime$_{rdmy}$ is crime rate in region $r$, on day-of-the-week $d$, in month $m$ and year $y$. Number of assaults per 100,000 individuals times 365. $X_{rdmy}$ contains school and public holidays and weather controls.\newline
