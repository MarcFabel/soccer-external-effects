...
% Summarizing paragraph??? XXX


\subsection{Threats to validity}
\begin{itemize}
	\item Displacement (spatial \& temporal)
	\item Home and away games
\end{itemize}
...
\subsubsection{Displacement Effects}
...
in last column of Table I find a positive effect - indicating that there is no offsetting gooing on, but if there are any displacement effects across time, then they are positive
...
\subsubsection{Home and away games}
