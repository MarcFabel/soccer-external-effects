...
\begin{abstract}\noindent 
	\footnotesize{\begin{center}\textbf{Abstract}\end{center} This paper investigates the impact of professional football games on the rate of physical assaults in Germany. I exploit time series and cross-sectional variation in crime registers, which contain detailed information on all victims from 2011-2015. I find that a home game leads to an increase of the assault rate by 21.5 percent. The effects are largely driven by male victims, who do not know the perpetrator. The effect size is decreasing with age. In total, professional football games explain almost 18 percent of the assault reports and generate annual social costs of 95 million euros.	\\\newline \textbf{Keywords:} football games, violent crime, assaults. \newline \textbf{JEL codes:} J19, K42, Z13, Z29.}
