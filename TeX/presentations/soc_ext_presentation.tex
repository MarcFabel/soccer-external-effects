	...
	\begin{frame}{Data}\label{CRIME_DATA}
		\begin{block}{Crime data}
			\begin{itemize}
				...
				\newline\hyperlink{CRIMINAL_OFFENSE_CODES}{\beamerbutton{Offense codes}}
			\end{itemize}
		\end{block}	
	\end{frame}
	...
	\begin{frame}{Data}\label{link_weather_data}
		\begin{block}{Weather}
			\begin{itemize}
				...
				\item use weather monitors with closest proximity to the stadium \newline \hyperlink{link_map_stadiums}{\beamerbutton{map weather monitors}} \hyperlink{link_hist_dist_monitor_stadiums}{\beamerbutton{Quality of the match}}
			\end{itemize}
		\end{block}
