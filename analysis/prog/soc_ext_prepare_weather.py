...
z_map_stadium_weather_monitor_input = 'C:/Users/fabel/Dropbox/soc_ext_Dx/analysis/data/intermediate/maps/' # comes as output from QGIS, generated by "Distance to nearest hub"
...
# read out
monitors.to_csv(z_weather_output_Dx + 'weather_monitors_coordinates_inner_merge.csv', sep=';', encoding='UTF-8')
...
# read out
weather.to_csv(z_weather_output_Dx + 'weather_prepared.csv', sep=';', encoding='UTF-8')
