...
map_stadium_weather_monitor = 'C:/Users/fabel/Dropbox/soc_ext_Dx/analysis/data/intermediate/maps/' # comes as output from QGIS, generated by "Distance to nearest hub"
...
stadium_monitor = pd.read_csv(map_stadium_weather_monitor + 'map_stadium_nearest_weather_monitor.csv', sep=';', encoding = 'UTF-8')
